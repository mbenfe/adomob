        ...
        Flexible(
          child: SfRadialGauge(axes: <RadialAxis>[
            RadialAxis(minimum: 0, maximum: 100, ranges: <GaugeRange>[
              GaugeRange(startValue: 0, endValue: 40, color: Colors.yellow, startWidth: 10, endWidth: 10),
              GaugeRange(startValue: 40, endValue: 75, color: Colors.green, startWidth: 10, endWidth: 10),
              GaugeRange(startValue: 75, endValue: 80, color: Colors.orange, startWidth: 10, endWidth: 10),
